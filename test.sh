...
echo 7- Again just to make sure our program is working!! Try to run ./push-swap "<5 random numbers>" with 5 random numbers instead of the tag. Does it display a valid solution and less than 12 instructions?
echo Enter 5 numbers seperated by spaces: 
read -p "> " Input
go run ./push-swap "$Input"
